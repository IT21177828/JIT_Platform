              ...
              <TableRow className="border-b border-blue-100 dark:border-white/[0.05]">
                ...
                >
                  <motion.div
                    ...
                    className="flex items-center gap-2"
                  >
                    <div className="p-1.5 rounded-full bg-gradient-to-r from-pink-100 to-pink-200 dark:from-pink-900/50 dark:to-pink-800/50">
                ...
                {loading ? (
                  ...
                  currentRecords.map((session, index) => (
                    <motion.tr
                      ...
                      className="hover:bg-gradient-to-r hover:from-blue-50/70 hover:to-purple-50/70 dark:hover:bg-white/[0.03] transition-colors cursor-pointer"
                    >
